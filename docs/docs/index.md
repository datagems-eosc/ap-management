...
The platform AP Management Api service acts as the ... for DataGEMS [user interface](https://datagems-eosc.github.io/dg-app-ui) and any other integrating clients that want to utilize the DataGEMS offerings.
