...
if TYPE_CHECKING:
    from .node_properties import Node_properties

@dataclass
class Node(AdditionalDataHolder, Parsable):
    ...
    properties: Optional[Node_properties] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "properties": lambda n : setattr(self, 'properties', n.get_object_value(Node_properties)),
        }
        return fields
