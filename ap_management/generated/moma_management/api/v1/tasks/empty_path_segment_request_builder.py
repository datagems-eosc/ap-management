...
class EmptyPathSegmentRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: CreateTaskRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PostResponse]:
        """
        Create a new Task node.Returns the created Task's ``id``.
    ...
    def to_post_request_information(self,body: CreateTaskRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new Task node.Returns the created Task's ``id``.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
