...
if TYPE_CHECKING:
    from ....models.create_ml_model_request import CreateMlModelRequest
...
class EmptyPathSegmentRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[list[Node]]:
        """
    ...
    async def post(self,body: CreateMlModelRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PostResponse]:
        """
    ...
    def to_post_request_information(self,body: CreateMlModelRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new ML_Model node. Returns the created model's ``id``.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
